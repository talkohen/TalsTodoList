...
// an activity for viewing current user's tasks in status "pending" ,"accepted" or "in progress"
public class employeeWaitingTasksActivity extends ListActivity {
    ...
    private static String url_pending_Tasks = "http://kerenpeles.net/android_connect/get_pending_tasks.php";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_employee_waiting_tasks);

        Intent myIntent = getIntent(); // gets the previously created intent
        username = myIntent.getStringExtra("username"); // will return "FirstKeyValue"
        password= myIntent.getStringExtra("password"); // will return "SecondKeyValue
        ...
        lv.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                // launching View task details Screen
    ...
    class LoadAllTasks extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(employeeWaitingTasksActivity.this);
...
try {
    ...
    JSONObject json = jParser.makeHttpRequest(url_pending_Tasks, "POST", params);
            ...
            runOnUiThread(new Runnable() {
                public void run() {
                    ...
                    ListAdapter adapter = new SimpleAdapter(
                            employeeWaitingTasksActivity.this, TasksList,
    ...
    //Open all tasks activity

    public void allTasksButtonClicked (View v) {

        Intent myIntent = new Intent(this, employeeAllTasksActivity.class);
