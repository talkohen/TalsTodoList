...
public class viewTaskDetailsActivity extends Activity {
    ...
    public  void editButtonClicked (View v){
               ...
               new SaveTaskDetails().execute(title,category,priority,location,date,
                       member,acceptanceStatus,progressStatus, image);
    ...
    private void setValues(JSONObject json ) throws JSONException {
        ...
        txtAcceptance.setFocusable(false);
        txtProgress.setFocusable(false);
    ...
    class GetTaskDetails extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            super.onPreExecute();
            pDialog = new ProgressDialog(viewTaskDetailsActivity.this);
