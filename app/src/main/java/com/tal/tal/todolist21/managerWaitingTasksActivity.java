...
// an activity for viewing users tasks in status "pending" ,"accepted" or "in progress"
public class managerWaitingTasksActivity extends ListActivity {
    ...
    private static String url_all_Tasks = "http://kerenpeles.net/android_connect/get_pending_team_tasks.php";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_manager_waiting_tasks2);
    ...
    class LoadAllTasks extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(managerWaitingTasksActivity.this);
            ...
            runOnUiThread(new Runnable() {
                public void run() {
                    ...
                    ListAdapter adapter = new SimpleAdapter(
                            managerWaitingTasksActivity.this, TasksList,
    ...
    public void allTasksButtonClicked (View v) {
        ...
        Log.d(username, "allTasksButtonClicked:00000 ");
        Intent myIntent = new Intent(this, managerAllTasksActivity.class);
        myIntent.putExtra("username", username);
        myIntent.putExtra("password", password);
        Log.d(username, "allTasksButtonClicked:111111 ");
